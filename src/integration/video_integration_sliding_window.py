...
#GLOBAL VARIABLES
modelPath = "../../models/modelGist20.h5"
sourcePath = "../../VIDEO/MARATON/IMG/"
destPath = "../../VIDEO/MARATON/IMG_L/"
...
def extractPeopleInImage(imagePath, model):
    ...
    img = Image.open(sourcePath + imagePath)
    ...
    clone.save(destPath + imagePath, 'JPEG')
